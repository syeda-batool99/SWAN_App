...
const ClosedRoom = ({navigation}) => {
    ...
    const RoomAccess = ()=>{
        ...
        return(
            <View style = {{alignSelf:'center', alignItems:'center', width:'90%'}}>
                <AppText heading size = {18}>Room Access</AppText>

                <View style = {{alignSelf:'center', marginVertical:10}}>
                    <AppText>Who Else Should Join?</AppText>
                </View>

                <View style = {{ width:'100%', marginVertical:15}}>
                    <RadioButton.Group onValueChange={newValue => setValue(newValue)} value={value}>
                        <View style = {{flexDirection:'row',justifyContent:'space-between'}}>
                            <View style = {{paddingTop:5, flexDirection:'column', justifyContent:'space-between'}}>
                                <AppText button>Open Room</AppText>
                                <AppText size = {12} color="grey">Everyone Can Join</AppText>
                            </View>
    ...
    return (
        <View style= {styles.container}>
            ...
            <View style = {styles.mainContainer}>
                ...
                <View style = {styles.closeRoomPart}>
                    <View style ={{justifyContent:'center'}}>
                        <AppText color = "#66737F" size = {10}>This Is Close Room</AppText>
                    </View>
                    <View style = {{height:30, width:80 ,backgroundColor:'#F7F7F9', borderRadius:10}}>
                        <AppButton onPress = {()=>refRBSheet3.current.open()} label = "Open it up..." textStyle ={{fontSize : 10}}  textColor = "#66737F" />
                    </View>
